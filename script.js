...
//Obtendo as chaves do objeto de cores para acessar o valor da cor
const mainTypes = Object.keys(colors)


//Enviando uma solicitação de API para cada Pokémon
...
// Envie uma solicitação para PokeApi e obtendo dados JSON sobre cada Pokémon
...
//Crie um cartão de informações para cada Pokémon
const createPokemonCard = (pokemon) =>{
    ...
    const color = colors[type]
     ...
     `
    //Bordas coloridas para cada tipo de Pokemon
